...
export class TemplateFormComponent implements OnInit {
  ...
  displayJson(form): void {
    ...
    // this.messageService.add({severity: 'success', summary: 'Submitted successfully', detail: 'Template form data is displayed successfully in child component'})
    this.growlMsgs.push({severity: 'success', summary: 'Submitted successfully', detail: 'Template form data is displayed successfully in child component'});
  }
